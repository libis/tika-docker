This repo was forked to add Dutch language support. The following changes were mad:
* tesseract-ocr-nld added to the docker file.
* Hard coded TIKA_VERSION=2.9.1 in docker file. Version comes from https://downloads.apache.org/tika/
